...
- **Environment snapshot:** `gilligan-environment-snapshot.md`.
- **TRIM IT schema/DB discovery:** `Arbor AI/Trim IT Repairs/TrimiIt Data Base/` + live `Reference-TrimITArchitecture.cfm`.
- **UI spec:** `gsts-ui-spec-v1.0.md`.
- **Deploy playbook:** `DEPLOY-PLAYBOOK.md` (also distilled into `../contracts/dev-handoff-contract.md`).

## Also at workspace root (boot-loaded)
- `TOOLS.md` — environment-specific tool notes (SSH hosts, voices, etc.).
