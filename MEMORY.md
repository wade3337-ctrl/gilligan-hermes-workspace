...
🎯 **ACTIVE GOAL (2026-07-10): 4-dashboard deploy bundle** → open `arbor-stack/release-candidates/DEPLOY-BUNDLE-2026-07-10.md` (RC-02 Revenue · RC-06 Production · RC-03 City Budgets · RC-04 SPM: complete-verify each → pre-prod checks `deploy-manifest.js`+`deploy-smoketest.sh` → one deploy package). **+ decide when RGC folds into this bundle.**
