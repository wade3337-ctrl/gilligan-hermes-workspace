...
## Wave 3 (done, 2026-07-20) — Los Serranos + Vintage Hills held
1. Wolf Creek — Temecula — HOA ✅ (Avalon Management Group, 951-244-0048)
2. Morgan Hill — Temecula — HOA (upscale) ✅ (Walters/RealManage, 951-691-5610)
3. Los Serranos — Chino Hills — HOA (1920s golf community) ⏸️ SKIPPED — no unified HOA (see HELD note)
4. Victoria Gardens — Rancho Cucamonga — Commercial ✅ (Prism Places / Redwood West+Panattoni)
...
1. Read this file → take the next un-pushed wave.
2. For each target: web-verify current management company + best contact (phone/manager); flag confidence (VERIFIED vs re-verify).
3. Bigin load into "Inland Empire Expansion" pipeline: account (link existing, don't dupe) + contact + deal (Stage "Potential Lead", Owner Chad Bouck id 5275136000002097047, Closing_Date ~90d out, Layout 5275136000002190772). Description = segment/city/mgmt+phone/why/confidence/wave#.
4. Update "LAST PUSHED" above + move the wave to a "Done" note.
5. Email/notify Skipper a summary of the 6 pushed + any that need him.
- Bigin creds: `~/.secrets/bigin-oauth.json` (refresh token). Access = create/edit only, NOT delete.
