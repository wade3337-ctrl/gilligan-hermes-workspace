...
**$610K of loaded friction on $25.1M of revenue (the 2026 goal) ≈ 2.4 margin points.** Recovering two-thirds of it is ≈$407K — **1.6 points on today's revenue, and 0.8 points on the $50M base where the 5-point expansion is actually promised.** The larger prize is not the $407K itself but the overhead we never add on the way to $50M. *(Note: this lands on EBITDA and therefore enterprise value. It does **not** move the earnouts, which run on AGP and exclude overhead.)*
...
- It names the **E-Traveler as "the biggest bottleneck"** — consistent with our measurement (30 min/bid, team-confirmed, the largest single friction step). ⚠️ **This document was commissioned by the COO, so it is NOT independent corroboration and is never to be cited as evidence.** Its value is as a statement of *what the vendor side intends to build.*
...
|---|---|---|
| `Proposals.Approved` | **0 of 5,033** | dead field |
| `Proposals.DateApproved` | **0 of 5,033** | dead field |
| Proposal status = "Lost" | 194 of 5,033 (3.9%) | **misleading on its own** |
...
| Activation | go-ahead → work order | ours | ⚠️ p90 29 days — see §4.2 |
...
- **✅ The zero-revenue-hours question is resolved (2026-07-25) and it changes this target.** The ~21,000 hours were **not** unbilled work — **they are zero-dollar crew sheets on work orders that carry revenue on other sheets.** The dominant cause (53% of the hours) is **two or more crews on the same job the same day** — all the production is reported on one crew's sheet and the others show hours against nothing; the rest is production landing on a different day of the same job. *(Corrected 2026-07-25 — previously described as multi-visit; verified on `CrewSheets.NetTotal`.)*
...
**In scope, and stated plainly:** the recovered friction comes out as **lower administrative overhead** — that is the EBITDA and valuation case. **What we are not doing is cutting the field.** The reduction is in administrative labor created by the system, taken primarily by **not hiring into growth** rather than by cutting today's team where that is achievable. *We are buying the ability to double revenue without doubling the back office.*
