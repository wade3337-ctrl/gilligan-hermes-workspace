# Conflicts & flags (Verifier E)

## Open conflicts
1. **George Junior Ainsworth b.1920 vs. parents' marriage 1 Jan 1926.**
   Listed as a sibling of Donald (child of Norman × Adeline), but born 6 years BEFORE their documented 1926 Cook Co. marriage. Options: (a) George's birth year wrong, (b) child from an earlier relationship, (c) tree error. Needs a record on George Junior. Do NOT treat George as a full sibling until resolved.

2. **Jack Roger Wade death year: 2006 (family) vs 2008 (obit/FamilySearch profile URL).** Unresolved — Branch C to verify via CA Death Index / obituary image.

## Handoff corrections (verified better data found)
- Adeline Eischen: "circa 1901, birthplace unknown" → **21 Aug 1900, Park Ridge, Cook Co., Illinois**; death **25 Nov 1990, San Diego**.
