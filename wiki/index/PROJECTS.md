...
- 📦 **MuniBot data warehouse** — Brent's ~200GB municipal bid data → MuniBot. Receiver built+proven (one-hop rsync from share → bind-mounted warehouse). ▶️ [[munibot-data-warehouse]] ⏳ Skipper runs `SyncMuni v4` at the office; watchdog armed.
